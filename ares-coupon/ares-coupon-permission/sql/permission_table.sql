-- 创建路径信息表
CREATE TABLE IF NOT EXISTS `coupon_path`
(
  ...
  AUTO_INCREMENT = 10
  DEFAULT CHARSET = utf8 COMMENT ='路径信息表';

-- 创建用户角色表
CREATE TABLE IF NOT EXISTS `coupon_role`
(
...
CREATE TABLE IF NOT EXISTS `coupon_role_path_mapping`
(
  ...
  AUTO_INCREMENT = 10
  DEFAULT CHARSET = utf8 COMMENT ='角色路径映射表';

-- 创建 User 与 Role 的映射关系表
CREATE TABLE IF NOT EXISTS `coupon_user_role_mapping`
(
  ...
  AUTO_INCREMENT = 10
  DEFAULT CHARSET = utf8 COMMENT ='用户角色关系映射表';
